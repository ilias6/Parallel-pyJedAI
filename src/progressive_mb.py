...
RESULTS_STORE_PATH = to_path('/home/gpapadakis/ccer/newresults/mb' + EXPERIMENT_NAME + '.json')
...
BEST_WORKFLOWS_STORE_PATH = to_path('/home/gpapadakis/ccer/bestresults/mb' + EXPERIMENT_NAME + '.json')
